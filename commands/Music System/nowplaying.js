...
module.exports = {
  ...
  aliases: ['np'],
	...
	async execute(client, message, args) {
        ...
        if (!client.player.getQueue(message)) return message.channel.send(require('../../messages.json'));
        ...
        const embed = new Discord.MessageEmbed()
        	...
        	.setFooter(require('../../messages.json').embed_footer.replace('(NAME)', message.author.username) + ` ${message.author.username}`, message.author.avatarURL())
        	.setTimestamp()
